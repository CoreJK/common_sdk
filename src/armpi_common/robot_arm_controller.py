...
if __name__ == '__main__':
    ...
    # logger.info(controller.get_all_joints_load_status())
    # logger.info(controller.set_all_joints_load_status(1))
    # logger.info(controller.get_all_joints_load_status())    
    # logger.info(controller.set_all_joints_load_status(0))
    while True:
        logger.info(controller.get_all_joint_position())
        joint_angles = controller.get_all_joint_position(pulse_to_angle=True)
        logger.info(np.round(np.degrees(joint_angles['position_list']), 3).tolist())
        time.sleep(0.5)
